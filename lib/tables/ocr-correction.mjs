...
const OCR_CORRECTION_DICTIONARY = [
  ...
  { pattern: /yyyy\/mm\/dd hh:mm:ss\.sss/gi, replacement: 'yyyy/mm/dd hh:mm:ss', description: 'date .sss removal' },
  { pattern: /yyyy\/MM\/dd HH:mm:ss\.sss/g, replacement: 'yyyy/MM/dd HH:mm:ss', description: 'date .sss removal' },
  { pattern: /yyyy\/MM\/dd HH:mm:ss\.SSS/g, replacement: 'yyyy/MM/dd HH:mm:ss', description: 'date .sss removal' },
];
