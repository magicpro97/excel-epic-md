...
- FORMATTING TAGS: Cell Values phía trên có thể chứa các tag định dạng:
  + ~~text~~ [strikethrough] = nội dung đã bị XÓA, KHÔNG đưa vào requirement
  + [red] = nội dung MỚI/THAY ĐỔI trong phiên bản hiện tại
  + [contains-strikethrough] = cell chứa cả text cũ (~~bị xóa~~) và text mới
  Khi trích xuất requirement, chỉ lấy phần KHÔNG bị strikethrough.
`;
